                ...
                <div class="col p-1">
                    <div class="card p-3">
                            ...
                            <div class="col-5">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-start"><?= $global_stats['total_clients']->value ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-start">Número total de clientes inativos</td>
                                        <td class="text-start"><?= $global_stats['total_deleted_clients']->value ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-start">Número médio de clientes por agentes</td>
                                        <td class="text-start"><?= sprintf("%.2f", $global_stats['average_clients_per_agents']->value) ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-start">Idade do cliente mais novo</td>
                                        <td class="text-start"><?= $global_stats['youngest_client']->value ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-start">Idade do cliente mais velho</td>
                                        <td class="text-start"><?= $global_stats['oldest_client']->value ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-start">Média de idade dos clientes</td>
                                        <td class="text-start"><?= sprintf("%.2f", $global_stats['average_age']->value) ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-start">Porcentagem de clientes homens</td>
                                        <td class="text-start"><?= sprintf("%.2f", $global_stats['percentage_males']->value) ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-start">Porcentagem de clientes mulheres</td>
                                        <td class="text-start"><?= sprintf("%.2f", $global_stats['percentage_females']->value) ?></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            <a href="?ct=admin&mt=create_pdf_report" target="_blank" class="btn btn-secondary px-4"><i class="fa-file-pdf me-2">  Criar relatorio em PDF </i></a>
                    </div>
